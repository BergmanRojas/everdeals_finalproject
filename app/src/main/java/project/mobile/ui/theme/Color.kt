...
val Dark161C2A = Color(0xFF161C2A) // Fondo oscuro
val WhiteFFFFFF = Color(0xFFFFFFFF) // Fondo claro y texto sobre primario/secundario
val Black = Color(0xFF000000) // Texto sobre fondo claro

// Colores adicionales
val RedFF0000 = Color(0xFFFF0000) // Errores
